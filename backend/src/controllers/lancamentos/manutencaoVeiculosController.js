...
const manutencaoVeiculosController = {
    create: async (req, res) => {
        try {
            ...
            const [result] = await pool.query(
                `INSERT INTO lancamentos_manutencao_veiculos 
    ...
    getAll: async (req, res) => {
        try {
            ...
            let query = `
                ...
                FROM lancamentos_manutencao_veiculos l
    ...
    update: async (req, res) => {
        try {
            ...
            const [result] = await pool.query(
                `UPDATE lancamentos_manutencao_veiculos 
    ...
    delete: async (req, res) => {
        try {
            const { id } = req.params;
            const [result] = await pool.query(
                'DELETE FROM lancamentos_manutencao_veiculos WHERE id = ?',
                [id]
            );
...
module.exports = manutencaoVeiculosController;