...
const materialConsumoController = {
    create: async (req, res) => {
        try {
            ...
            const [result] = await pool.query(
                `INSERT INTO lancamentos_material_consumo 
    ...
    getAll: async (req, res) => {
        try {
            ...
            let query = `
                ...
                FROM lancamentos_material_consumo l
    ...
    update: async (req, res) => {
        try {
            ...
            const [result] = await pool.query(
                `UPDATE lancamentos_material_consumo 
    ...
    delete: async (req, res) => {
        try {
            const { id } = req.params;
            const [result] = await pool.query(
                'DELETE FROM lancamentos_material_consumo WHERE id = ?',
                [id]
            );
...
module.exports = materialConsumoController;