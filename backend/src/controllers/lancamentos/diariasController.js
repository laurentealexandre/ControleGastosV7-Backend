...
const diariasController = {
    create: async (req, res) => {
        try {
            ...
            const [result] = await pool.query(
                `INSERT INTO lancamentos_diarias 
    ...
    delete: async (req, res) => {
        try {
            const { id } = req.params;
            const [result] = await pool.query(
                'DELETE FROM lancamentos_diarias WHERE id = ?',
                [id]
            );
...
module.exports = diariasController;