...
const almoxarifadoController = {
    create: async (req, res) => {
        try {
            ...
            const [result] = await pool.query(
                `INSERT INTO lancamentos_almoxarifado 
    ...
    getAll: async (req, res) => {
        try {
            ...
            let query = `
                ...
                FROM lancamentos_almoxarifado l
    ...
    update: async (req, res) => {
        try {
            ...
            const [result] = await pool.query(
                `UPDATE lancamentos_almoxarifado 
    ...
    delete: async (req, res) => {
        try {
            const { id } = req.params;
            const [result] = await pool.query(
                'DELETE FROM lancamentos_almoxarifado WHERE id = ?',
                [id]
            );
